...
from core.views.income import IncomeCategoryViewSet, IncomeCategoryMainViewSet, \
    IncomeCategorySubViewSet, IncomeViewSet
...
router.register(r'income_categories', IncomeCategoryViewSet)
router.register(r'income_category_main', IncomeCategoryMainViewSet)
router.register(r'income_category_sub', IncomeCategorySubViewSet)
